...
export class LivroRepository {
  ...
  async insereLivro(livro: LivroEntity): Promise<LivroEntity> {
    ...
    async findByIsbn(isbn: string): Promise<LivroEntity> {
    ...
    async findById(id: number): Promise<LivroEntity> {
    ...
    async findByAutorEditoraEdicao(autor: string, editora: string, edicao: string): Promise<LivroEntity> {
    ...
    async removeLivroPorIsbn(isbn: string): Promise<void> {
    ...
    async updateLivroPorIsbn(livro: LivroEntity): Promise<LivroEntity> {
